...
contract MyAdvancedToken is owned, IdentityToken {
    ...
    */
    ...
    mapping(uint256 => bool) public validCredentials;
    ...
    */
    ...
    function addValidCredential(uint256 credentialHash) public onlyOwner {
        validCredentials[credentialHash] = true;
    }

    // User calls this to have identiy registered
    function getIdentityToken(uint256 credentialHash) public {
        require(validCredentials[credentialHash], "Invalid credential");

        address recipient = msg.sender;
        uint256 mintedAmount = 1000000000000000000;
        ...
        emit Transfer(address(this), recipient, mintedAmount);
    }
